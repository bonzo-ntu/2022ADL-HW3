...
print("-" * 100)
print(f"get gpu? {torch.cuda.is_available()}")
print("-" * 100)
...
class DataTrainingArguments:
    ...
    #     default=False,
    #     metadata={"help": "Whether or not to use 16-bits training. " "which is used during ``training``."},
    # )
...
def main():
    ...
    def preprocess_function(examples):
        ...
        print(type(inputs))
        print("-" * 100)
        print(f"prefix:{prefix}, input:{inputs[:2]}")
        print(dir(inputs))
